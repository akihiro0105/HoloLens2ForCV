...
namespace BasicHologram
{
    ...
    {
    public:
        GyroRenderer(std::shared_ptr<DX::DeviceResources> const& deviceResources, IResearchModeSensor* pGyroSensor, HANDLE hasData, ResearchModeSensorConsent* pCamAccessConsent)
        {
